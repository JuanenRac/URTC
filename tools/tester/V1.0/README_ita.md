...
**Versione:** 1.0 · **Autore:** JuanenRac (Electro Hobby 3D) &lt;electrohobby3d@gmail.com&gt;
...
Questo strumento e `tools/flasher/V1.0/` condividono lo stesso layer di
...
sezione 1 del flasher - vedi `tools/flasher/V1.0/README.md` sezioni 1 e
...
scritto automaticamente in `tools/tester/V1.0/logs/` (sicuro da
