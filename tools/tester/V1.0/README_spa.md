...
**Versión:** 1.0 · **Autor:** JuanenRac (Electro Hobby 3D) &lt;electrohobby3d@gmail.com&gt;
...
Esta herramienta y `tools/flasher/V1.0/` comparten la misma capa de
...
`tools/flasher/V1.0/README.md` secciones 1 y 2 en vez de duplicarlo
aquí.
...
escribe automáticamente en `tools/tester/V1.0/logs/` (seguro de borrar),
