...
**Version:** 1.0 · **Autor:** JuanenRac (Electro Hobby 3D) &lt;electrohobby3d@gmail.com&gt;
...
Dieses Tool und `tools/flasher/V1.0/` teilen sich denselben
...
Abschnitt 1 des Flashers - siehe `tools/flasher/V1.0/README.md`
...
automatisch nach `tools/tester/V1.0/logs/` geschrieben (sicher zu
