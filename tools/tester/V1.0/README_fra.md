...
Cet outil et `tools/flasher/V1.0/` partagent la même couche de transport
...
que la section 1 du flasher - voir `tools/flasher/V1.0/README.md`
...
automatiquement dans `tools/tester/V1.0/logs/` (sûr à supprimer), et
