...
This tool and `tools/flasher/V1.0/` share the same transport layer (SLCAN and
...
`tools/flasher/V1.0/README.md` sections 1 and 2 rather than duplicating it
here.
...
to `tools/tester/V1.0/logs/` (safe to delete), and **Export Debug Bundle**
