...
`tools/flasher/V1.0/`**, juste à côté de `urtc_flasher.py` :
...
`tools/flasher/V1.0/` plutôt qu'à la racine du dépôt signifie que tout
le dossier `tools/flasher/V1.0/` est autonome. Si vous voulez juste
flasher une carte — sur un PC d'atelier, depuis une clé USB, n'importe
où — vous pouvez copier `tools/flasher/V1.0/` seul sans rien d'autre du
...
`src/F303-master/V1.0/README.md`) - cette case existe pour un
