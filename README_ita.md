...
- **[HYDRA-UMC-DSI](https://github.com/JuanenRac/HYDRA-UMC-DSI)** — pianificato: una UI touch nativa per il touchscreen DSI da 7" proprio di HYDRA-UMC (1280×800) sul Compute Module 5, che controlla lo stesso server direttamente dalla scheda. Non ancora iniziato.
