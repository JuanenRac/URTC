...
// --- Start of this project's own addition, not part of Melexis's original file ---
// extern "C" linkage wrapper: this header's declarations (and this
// project's own .cpp definitions that include it) need C linkage so
// the rest of this project's own firmware, written in plain C, can
// call them without C++ name-mangling getting in the way. Nothing
// below this point changes any logic from Melexis's own original file
// - only the linkage.
#ifdef __cplusplus
extern "C" {
#endif
// --- End of this project's own addition ---
...
// --- Start of this project's own addition ---
#ifdef __cplusplus
}
#endif
// --- End of this project's own addition ---
