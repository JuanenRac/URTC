...
│   ├── URTC_MAIN_FIRMWARE_v0.2.7.bin    Anwendungs-bin kompiliert, flashen auf 0x08008000
│   ├── URTC_MAIN_FIRMWARE_v0.2.7.elf    Anwendungs-elf kompiliert, flashen auf 0x08008000
│   ├── URTC_MAIN_FIRMWARE_v0.2.7.hex    Anwendungs-HEX kompiliert, flashen auf 0x08008000 (Adresse eingebettet)
...
**Untergeordnete Projekte** — jedes davon ist ein Desktop- oder Browser-Tool, das speziell zum Flashen, Testen oder Steuern dieser Firmware gebaut wurde
- **[URTC-FLASHER](https://github.com/JuanenRac/URTC-FLASHER)** — Desktop-GUI-Flash-Tool für URTC-Platinen, CAN-OTA plus Full-Chip-SWD/JTAG; flasht genau diese Firmware.
- **[URTC-TESTER](https://github.com/JuanenRac/URTC-TESTER)** — Desktop-Live-CAN-Bus-Diagnosetool für URTC-Platinen, ein Panel pro Werkzeugprofil; ein Panel pro den eigenen 25 Werkzeugprofilen dieser Firmware.
- **[URTC-WEB-STUDIO](https://github.com/JuanenRac/URTC-WEB-STUDIO)** — browserbasierte Alternative zu URTC-TESTER über die Web-Serial-API, ohne lokale Installation; dasselbe CAN-Protokoll wie die beiden obigen Desktop-Tools.

**Direkt verwandt**
- **[HYDRA-UMC](https://github.com/JuanenRac/HYDRA-UMC)** — das physische Motherboard des Roboterarms: CM5-Host + Dual-Core-STM32H745, koordiniert bis zu 8 Werkzeugarme über CAN-OTA/SPI-OTA; sein eigener echter FDCAN2-Relay-Tunnel ist die Leitung, auf der der Werkzeugkopf dieser Firmware sitzt.
- **[HYDRA-UMC-SDK](https://github.com/JuanenRac/HYDRA-UMC-SDK)** — der gemeinsame JSON-Schema-Vertrag und die Sicherheitsschranke, gegen die jede Bridge ihre Befehle validiert; deckt auch Dienste, UIs, CM5-Adapter und diese Firmware ab.
- **[URTC-SMART-RACK](https://github.com/JuanenRac/URTC-SMART-RACK)** — Firmware für ein Platinenmontagegestell mit echter Werkzeug-ID-Dekodierung und Smart-Idle-Vorheizlogik; teilt das eigene Werkzeugökosystem und den CAN-Bus dieser Firmware.
- **[URTC-VISION-TOOL](https://github.com/JuanenRac/URTC-VISION-TOOL)** — Firmware plus ein echter Python-Vision-Begleiter für einen Thermal-/RGB-Inspektionswerkzeugkopf; teilt das eigene Werkzeugökosystem und den CAN-Bus dieser Firmware.
- **[HYDRA-UMC-DETECTION-HEF](https://github.com/JuanenRac/HYDRA-UMC-DETECTION-HEF)** — echte Registry für kompilierte Modelle mit Hailo-Architektur-/Prüfsummen-Safe-Load-Verifizierung; liefert die visuelle Erkennung hinter den eigenen Werkzeugen dieser Firmware.
