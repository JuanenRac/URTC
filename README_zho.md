...
│   ├── URTC_MAIN_FIRMWARE_v0.2.9.bin    应用程序 bin 编译产物，刷写至 0x08008000
│   ├── URTC_MAIN_FIRMWARE_v0.2.9.elf    应用程序 elf 编译产物，刷写至 0x08008000
│   ├── URTC_MAIN_FIRMWARE_v0.2.9.hex    应用程序 HEX 编译产物，刷写至 0x08008000（地址已内置）
